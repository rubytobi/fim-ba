...
public class Loadprofile {		
	...
	// 4 Werte f�r 15 Minuten Slots
	double value1, value2, value3, value4;
	
	// Zeitpunkt, ab wann das Lastprofil gelten soll
	Date date;
	
	// Erstellt aus �bergebenem Array neues Lastprofil
	public Loadprofile (double[] values, Consumer consumer, Date date) {
		// Pr�fe, dass der Consumer 4 15-Minuten-Slots will und dass das Profil zur vollen Stunde startet
