...
public class PossibleMatch implements Comparable<PossibleMatch> {
	...
	/**
	 * Liefert das aggregierte Lastprofil der beiden Angebote des moeglichen
	 * Matches.
	 * 
	...
	/**
	 * Liefert die Summe des aggregierten Lastprofils der beiden Angebote des
	 * moeglichen Matches.
	 * 
	...
	/**
	 * Liefert das Datum der beiden Angebote des moeglichen Matches.
	 * 
	...
	/**
	 * Liefert alle Informationen des moeglichen Matches als String.
	 * 
	...
	/**
	 * Ueberschreibt die Methode compareTo, so dass die moeglichen Matches
	 * aufsteigen nach ihrem finanziellen Output sortiert werden koennen.
	 */
	@Override
	...
	/**
	 * Ueberschreibt die Method equals. Zwei moegliche Matches werden als gleich
	 * angesehen, wenn sie aus den gleichen Angeboten bestehen.
	 */
	@Override
